      ...
      <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container flex h-16 items-center justify-between">
          ...
          <nav className="flex items-center gap-4">
            ...
            <Link href="/first-aid">
              <Button variant="outline">First Aid</Button>
            </Link>
          </nav>
        </div>
      </header>
              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="max-w-[600px] text-gray-500 md:text-xl dark:text-gray-400">
                    Connect with your doctor, manage appointments, and access your medical records from anywhere.
                  </p>
                </div>
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                  Our platform offers a comprehensive suite of tools for both doctors and patients.
                </p>
              </div>
            </div>
            <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 py-12 md:grid-cols-2 lg:grid-cols-3">
              <div className="flex flex-col items-center space-y-2 rounded-lg border p-6 shadow-sm">
                ...
                <p className="text-center text-gray-500 dark:text-gray-400">
                  Schedule, view, and manage appointments with ease.
                </p>
              </div>
              <div className="flex flex-col items-center space-y-2 rounded-lg border p-6 shadow-sm">
                <div className="flex h-12 w-12 items-center justify-center rounded-full bg-primary text-white">
              ...
              <div className="flex flex-col items-center space-y-2 rounded-lg border p-6 shadow-sm">
                ...
                <h3 className="text-xl font-bold">Real-time Consultations</h3>
                <p className="text-center text-gray-500 dark:text-gray-400">
              ...
              <div className="flex flex-col items-center space-y-2 rounded-lg border p-6 shadow-sm">
                ...
                <p className="text-center text-gray-500 dark:text-gray-400">
                  Connect with doctors in real-time or get AI assistance.
                </p>
              </div>
              <div className="flex flex-col items-center space-y-2 rounded-lg border p-6 shadow-sm">
                <div className="flex h-12 w-12 items-center justify-center rounded-full bg-primary text-white">
              ...
              <div className="flex flex-col items-center space-y-2 rounded-lg border p-6 shadow-sm">
                ...
                <h3 className="text-xl font-bold">First Aid Assistant</h3>
                <p className="text-center text-gray-500 dark:text-gray-400">
                  Get AI-powered first aid instructions in emergencies.
                </p>
              </div>
            </div>
          </div>
